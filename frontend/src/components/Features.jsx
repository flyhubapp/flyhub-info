  ...
  return (
    <section className="features" id="features">
      <div className="container" ref={containerRef}>
        <h2 className="reveal-child reveal-up">What Flyhub Offers</h2>        
        <div className="features-grid reveal-stagger-parent visible">
          {features.map((feature, index) => (
            <div key={index} className="feature-card reveal-child" style={{ backgroundImage: `url(${feature.bgImage})` }}>
