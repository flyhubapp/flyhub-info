...
const Categories = () => {
  ...
  return (
    <section className="flyhub-categories-section" id="categories">
      <div className="flyhub-categories-container" ref={containerRef}>
        <div className="flyhub-categories-header reveal-child reveal-up">
        ...
        <div className="flyhub-categories-grid reveal-stagger-parent visible">
          {categories.map((category, index) => (
            <div 
              key={index} 
              className="flyhub-categories-card reveal-child"
