...
Registration Date: ${new Date().toLocaleString()}
      ...
      window.location.href = `mailto:flyhubapp@gmail.com?subject=New Buyer Registration - ${formData.fullName}&body=${encodeURIComponent(mailtoBody)}`;
          ...
          <div className="form-footer">
            <div className="terms-agreement">
              ...
              <label htmlFor="terms">
                ...
                <a href="/shipping" target="_blank" rel="noopener noreferrer">Shipping Policy</a> and{' '}
