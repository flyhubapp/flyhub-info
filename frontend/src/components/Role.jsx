...
const Role = () => {
  ...
  return (
    <div className="platform-roles" ref={containerRef}>
      {/* Section Header */}
      ...
      <div className="roles-compact-container reveal-stagger-parent visible">
        {/* Buyer Card */}
        <div className="compact-role-card buyer-card reveal-child">
          <div 
        ...
        {/* Seller Card */}
        <div className="compact-role-card seller-card reveal-child">
          <div 
            className="role-image"
            style={{ 
      ...
      {/* Training Section */}
      <div className="training-section reveal-child reveal-up">
      ...
      {/* Platform Benefits */}
      <div className="platform-benefits reveal-child reveal-up reveal-stagger-parent visible">
        <div className="benefit-item reveal-child">
